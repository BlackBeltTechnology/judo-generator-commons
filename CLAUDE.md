...
**Modular Documentation** (also packaged in JAR):
- `/src/main/resources/agent-docs/index.md` - Documentation entry point
- `/src/main/resources/agent-docs/components/` - Per-component docs
- `/src/main/resources/agent-docs/guides/ai-assistant.md` - Quick reference

**Claude Skills**:
- `/.claude/skills/generate-helper/` - Create new helper classes
- `/claude-marketplace.json` - Skill catalog
